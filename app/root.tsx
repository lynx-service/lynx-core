            ...
            <aside className="text-sm bg-white dark:bg-gray-900 w-40 min-h-screen border-r border-gray-200 dark:border-gray-700 hidden md:flex flex-col fixed left-0 top-16 shadow-lg">
              <nav className="flex flex-col h-full py-4 px-2">
                <div className="flex-grow space-y-2">
                  ...
                  <Link to="/content-management" className="block px-4 py-2 rounded-lg text-gray-600 dark:text-gray-300 hover:bg-emerald-600 hover:text-zinc-100 dark:hover:bg-gray-700">
                    コンテンツ管理
                  </Link>
                  <Link to="/reports/internal-links-map" className="block px-4 py-2 rounded-lg text-gray-600 dark:text-gray-300 hover:bg-emerald-600 hover:text-zinc-100 dark:hover:bg-gray-700">
                    Reports
                  </Link>
