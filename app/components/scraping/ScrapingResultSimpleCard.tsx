...
interface ScrapingResultSimpleCardProps {
  item: SimpleScrapingResultItem;
  onClick: () => void;
}

export function ScrapingResultSimpleCard({ item, onClick }: ScrapingResultSimpleCardProps) {
  return (
    <div
